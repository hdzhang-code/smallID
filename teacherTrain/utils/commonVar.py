...
# transfer data across script
TRANSFER_FEW_SHOT_UTT_LIST = 'transfer_few_shot_utt_list'
TRANSFER_FEW_SHOT_LAB_LIST = 'transfer_few_shot_lab_list'
FEW_SHOT_DATA_DIR = './few_shot_data_dir'
